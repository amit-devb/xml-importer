...
class MalformedXmlFactory implements BaseTestFileFactory
{
    ...
    <catalog>';
        $numberOfItems = 1; // Change this number to generate more or fewer items
    ...
    ';
        ...
        $file = __DIR__ . '/../fixtures/malformed_content_test_case.xml';
